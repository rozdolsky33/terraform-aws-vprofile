resource "aws_elastic_beanstalk_environment" "vr-vprofile-mybean-prod" {
  name                = "vr-vprofile-bean-prod"
  application         = aws_elastic_beanstalk_application.vr-vprofile-prod.name
  solution_stack_name = "64bit Amazon Linux 2 v4.2.15 running Tomcat 8.5 Corretto 11"
  cname_prefix        = "vr-vprofile-mybean-prod-domain"
  setting {
    name      = "VPCId"
